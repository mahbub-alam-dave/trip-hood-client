...
const BookingSuccessModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--color-bg)] dark:bg-[var(--color-bg-dark)] bg-opacity-60 flex justify-center items-center z-50">
      <div className="bg-white dark:bg-[var(--color-bg-primary-dark)] rounded-2xl p-8 w-[90%] max-w-md text-center shadow-xl relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            onClick={onClose}
            className="w-full px-4 py-2 rounded-lg bg-[var(--color-primary)] text-white font-semibold hover:bg-[var(--color-primary-dark)] transition"
          >
            Confirm Booking
          </button>
          ...
          <Link
            ...
            className="w-full px-4 py-2 rounded-lg border border-[var(--color-primary)] text-[var(--color-primary)] font-semibold hover:bg-[var(--color-primary)] hover:text-white transition text-center"
          >
            See All Bookings
          </Link>
        </div>
